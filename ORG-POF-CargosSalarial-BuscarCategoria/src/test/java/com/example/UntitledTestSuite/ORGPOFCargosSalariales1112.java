...
public class ORGPOFCargosSalariales1112 {
  ...
  public void testORGPOFCargosFuncionales1012() throws Exception {
    ...
    driver.get("https://nexocapacitacion.jujuy.edu.ar:8181/#/pages/cargosalarial/listar");
    ...
    try {
        ...
        driver.findElement(searchInput).sendKeys("CATEGORIA 01");
